...
compiler_list="icc:icpc:intel/ics-18.0.4 icc:icpc:intel/ics-19.1.1 clang:clang++:dev/clang-9.0.1 gcc:g++:dev/gcc-8.3.0 gcc:g++:dev/gcc-9.3.0 gcc:g++:dev/gcc-10.1.0"
